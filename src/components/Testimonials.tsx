...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    {
      text: "Теперь на онлайн-встречах показываем объекты через виртуальные туры — команда принимает решения быстрее и увереннее.",
      author: "Управляющий отеля",
      company: "Международная сеть отелей",
    },
    {
      text: "Инвесторы принимали решения дистанционно. +25% продаж на этапе котлована.",
      author: "Девелопер",
      company: "Крупная девелоперская компания",
    },
    {
